    ...
    <header className={`tdr-header ${isScrolled ? 'shadow-lg' : ''}`}>
      ...
      <div className="md:hidden bg-primary border-t border-white/10 py-5 px-6 overflow-y-auto max-h-[calc(100vh-88px)]">
          <nav className="flex flex-col gap-1">
            ...
            <Link to="/corporate" className="text-white font-bold text-sm uppercase tracking-wider py-3 min-h-[44px] flex items-center" onClick={() => setIsMobileMenuOpen(false)}>Корпоративное сообщество</Link>
